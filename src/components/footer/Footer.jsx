        ...
        <div className="footer">
            <div className="fLists">
                ...
                <ul className="fList">
                    ...
                    <li className="fListItem">Hondabooking.com for Travel Agents</li>
                </ul>
                <ul className="fList">
                    <li className="fListItem">Coronavirus (COVID-19) FAQs</li>
                    <li className="fListItem">Abount Hondabooking.com</li>
                    ...
                    <li className="fListItem">Privacy & cooike statement</li>
                    <li className="fListItem">MSA statment</li>
                    <li className="fListItem">Corporate contact</li>
                </ul>
            </div>
            <div className="fText">Copyright © 2023 HondaBooking </div>
        </div>
    )
}
